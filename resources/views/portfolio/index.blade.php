...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header h2 font-weight-bold">Portfolios
                    </div>
                    <div class="card-body">
                        <table class="table table-striped table-bordered">
                            ...
                            @foreach($portfolios as $portfolio)
                                <tr>
                                    <td>{{$portfolio->id}}</td>
                                    <td class="font-weight-bold">{{$portfolio->name}}</td>
                                    <td></td>
                                </tr>
                            @endforeach
                            </tbody>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-header h2 font-weight-bold">Add New Portfolio
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
