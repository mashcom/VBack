...
<div id="app">
    <nav class="navbar navbar-expand-md navbar-dark bg-dark  shadow-sm" style="background: #2196f3 !important;">
        ...
        <a class="navbar-brand font-weight-bold" href="{{ url('/') }}">MSU Assets System
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                @else
                    <li class="nav-item">
                        <a class="nav-link text-white text-uppercase font-weight-bold" href="{{ url('/asset') }}">Assets</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white text-uppercase font-weight-bold" href="{{ url('/asset/create') }}">New Asset</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-white text-uppercase font-weight-bold" href="{{ url('/calculator') }}">Recalculate Assets</a>
                    </li>
